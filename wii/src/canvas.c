...
#include "font.h"
#include "font_textures.h"
#include "font_textures_tpl.h"
...
void canvas_init(void) {
    ...
    // Load font texture
    TPLFile font_tpl;
    TPL_OpenTPLFromMemory(&font_tpl, (void *)font_textures_tpl, font_textures_tpl_size);
    TPL_GetTexture(&font_tpl, id_font, &canvas.font_texture);
}
